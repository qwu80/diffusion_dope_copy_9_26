...
if (real_graph_live ==0){
  ...
  beginShape();
      ...
      curveVertex(190*s_x,(171.25+197.5-array_plot_h_0.length*0.7)*s_y)
      curveVertex(190*s_x,(171.25+197.5-array_plot_h_0.length*0.7)*s_y)
     
  
    for (var k = 0; k < point_count; k++) {

        curveVertex((210+k*(950-210)/point_count)*s_x,(171.25+197.5-array_plot_h[k].length*0.7)*s_y)

    }
   

      curveVertex((950-(950-210)/point_count)*s_x,(171.25+197.5-array_plot_h[point_count-1].length*0.7)*s_y)
...
// for ( var i = 0; i < point_count; i++ ) {
  // if (i==0 ) {
    curveVertex(190*s_x,(171.25-array_plot_e_0.length*0.7)*s_y)
    curveVertex(190*s_x,(171.25-array_plot_e_0.length*0.7)*s_y)
  ...
  for (var k = 0; k < point_count; k++) {
    // if (i!=(point_count-1)||i!=(0)) {
      curveVertex((210+k*(950-210)/point_count)*s_x,(171.25-array_plot_e[k].length*0.7)*s_y)
    // }
  }
 
  // if (i==(point_count-1)) {
    curveVertex((950-(950-210)/point_count)*s_x,(171.25-array_plot_e[point_count-1].length*0.7)*s_y)
  // }
// }
...
line((10+100+70+change_square+940-change_length-70-20+4)*s_x,(171.25-3)*s_y,(10+100+70+change_square+790)*s_x,(171.25)*s_y)
//arrow up up
line((10+100+70+change_square+940-change_length-70-760-3)*s_x,46*s_y, (10+100+70+change_square+940-change_length-70-760)*s_x, (40)*s_y)
line((10+100+70+change_square+940-change_length-70-760+3)*s_x,46*s_y, (10+100+70+change_square+940-change_length-70-760)*s_x, (40)*s_y)
...
if (real_graph_live ==0){
  ...
  strokeWeight(1.5)
  line((10+100+70+change_square+940-change_length-70-760)*s_x,(10+385/2+96.25+70-changg)*s_y,(10+100+70+change_square+790-25)*s_x,(10+385/2+96.25+70-changg)*s_y)
...
// for ( var i = 0; i < point_count; i++ ) {
  // if (i==0 ) {
    curveVertex(190*s_x,(171.25-array_plot_e_0.length*0.7*3)*s_y)
    curveVertex(190*s_x,(171.25-array_plot_e_0.length*0.7*3)*s_y)
    // curveVertex(190*s_x,(171.25-array_plot[0].length*0.7)*s_y)
  ...
  for (var k = 0; k < point_count; k++) {
    // if (i!=(point_count-1)||i!=(0)) {
      curveVertex((210+k*(950-210)/point_count)*s_x,(171.25-array_plot_e[k].length*0.7*3)*s_y)
    // }
  }
 
  // if (i==(point_count-1)) {
    curveVertex((950-(950-210)/point_count)*s_x,(171.25-array_plot_e[point_count-1].length*0.7*3)*s_y)
  // }
// }
...
function remap(changg, oldMin, oldMax, newMin, newMax) {
  return newMin + (changg - oldMin) * (newMax - newMin) / (oldMax - oldMin);
}
...
function toSuperscript(num) {
  ...
  return num.toString().split('').map(char => map[char]).join('');
}


// Remap the value of changg
const remappedChangg = remap(changg, 0, 110, Math.pow(10, 13), Math.pow(10, 14));

// Compute the division
const result = Math.pow(10, 20) / remappedChangg;

// Extract the power of 10
const powerOf10 = result.toString().split('.')[0].length - 1;
const superscript = toSuperscript(powerOf10);
// console.log(superscript)

// Get the number in the form of x.yy
let firstDigits = parseFloat(result.toPrecision(3));

// Multiply x.yy by 10^(powerOf10 - 1)
let finalResult = firstDigits * Math.pow(10, powerOf10 - 1);

leadingNumber = finalResult / Math.pow(10, powerOf10)/Math.pow(10,6);
if (leadingNumber == 0.0911) {
  leadingNumber =1.0
  let formattedResult = `${leadingNumber.toFixed(2)}x10${'\u2076'}`;

// Print the formatted result
text(formattedResult, 154 * s_x, (172+12+2) * s_y);
...
if (real_graph_live ==0){
  ...
  strokeWeight(1.5)
  beginShape();
      curveVertex(190*s_x,(171.25+197.5-array_plot_h_0.length*0.7*3)*s_y)
      curveVertex(190*s_x,(171.25+197.5-array_plot_h_0.length*0.7*3)*s_y)
     
  
    for (var k = 0; k < point_count; k++) {

        curveVertex((210+k*(950-210)/point_count)*s_x,(171.25+197.5-array_plot_h[k].length*0.7*3)*s_y)

    }
   

      curveVertex((950-(950-210)/point_count)*s_x,(171.25+197.5-array_plot_h[point_count-1].length*0.7*3)*s_y)
...
line((10+100+70+change_square+940-change_length-70-760)*s_x,(171.25-changg)*s_y,(10+100+70+change_square+790-25)*s_x,(171.25-changg)*s_y)
// beginShape();
// // for ( var i = 0; i < point_count; i++ ) {
//   // if (i==0 ) {
...
leadingNumber = finalResult / Math.pow(10, powerOf10)/Math.pow(10,6);
if (leadingNumber == 0.1) {
  leadingNumber =1.0
  let formattedResult = `${leadingNumber.toFixed(2)}*10${toSuperscript(powerOf10)}`;

// Print the formatted result
text(formattedResult, 154 * s_x, (298 + 70 + 12 + 2) * s_y);

} else {
  
  let formattedResult = `${leadingNumber.toFixed(2)}*10${'\u2077'}`;
...
genBalls = (num) =>{
  ...
  // generate *num* balls
  if (sceneCount == 13 || sceneCount == 12 || sceneCount ==1.5|| sceneCount ==2||sceneCount ==3 ||sceneCount ==1.7 ){
    // console.log("haha")
    if (time_count>0) {
      whiteArray = [];
      blackArray = [];
...
add_e= (a) =>{
  ...
  changg = 36.666666666666664*a-4766.666666666666
  ...
  let ll = (Math.pow(10,(1/3)*a+(13-(130/3)))).toExponential(1)

  document.getElementById("add_e_text_2").value=ll
  time_count = 0;
...
add_h= (a) =>{
  ...
  changg = 40.666666666666664*a-5286.666666666666
  ...
  let ll = (Math.pow(10,(1/3)*a+(13-(130/3)))).toExponential(1)
  document.getElementById("add_h_text").value=ll
