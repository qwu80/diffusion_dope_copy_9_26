  ...
  let scene_0 = new ScrollMagic.Scene({
    ...
    .on('start', () => {
      if (sceneCount == 1.5) {
        ...
        document.getElementById("slider_13").value=130
        document.getElementById("add_h_text").value=(5*Math.pow(10,13)).toExponential(1)
        add_h(130)
        ///
        document.getElementById("slider_66").value=1
        document.getElementById("slider_77").value=1
        // document.getElementById("slider_10").value=1
        // document.getElementById("slider_11").value=1
        // document.getElementById("slider_12").value=1
    ...
    .on('start', () => {
      if (sceneCount == 2) {
        ...
        document.getElementById("slider_18").value=130
